...
const resetGame = () => {
  ...
  // leave stake as-is (1000 default) – or uncomment next line if you always want 1000
  // setPepStake("1000");
          ...
          <div className="pep-panel">
            ...
            <div className="pep-field-row">
              ...
              <input
                ...
                step="1"
                value={pepStake}
                onChange={(e) => setPepStake(e.target.value)}
              />
            </div>
            ...
            {/* Escrow addresses – simple, readable, full width */}
